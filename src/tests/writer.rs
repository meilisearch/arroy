...
fn write_vectors_until_there_is_a_split() {
    ...
    Tree 0: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(1), right: Tree(2), normal: [0.5774, 0.5774, 0.5774] })
    Tree 1: Descendants(Descendants { descendants: [0] })
    Tree 2: Descendants(Descendants { descendants: [1, 2, 3] })
    Item 0: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [0.0000, 0.0000, 0.0000] })
    Item 1: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [1.0000, 1.0000, 1.0000] })
    Item 2: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [2.0000, 2.0000, 2.0000] })
...
fn overwrite_one_item_incremental() {
    ...
    Tree 0: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(1), right: Tree(6), normal: [1.0000, 0.0000] })
    Tree 1: Descendants(Descendants { descendants: [0] })
    Tree 2: Descendants(Descendants { descendants: [1, 5] })
    Tree 3: Descendants(Descendants { descendants: [3, 4] })
    Tree 4: Descendants(Descendants { descendants: [2] })
    Tree 5: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(3), right: Tree(4), normal: [0.0000, 0.0000] })
    Tree 6: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(2), right: Tree(5), normal: [0.0000, 0.0000] })
    ...
    Tree 1: Descendants(Descendants { descendants: [0] })
    Tree 2: Descendants(Descendants { descendants: [1, 5] })
    Tree 5: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(7), right: Tree(8), normal: [0.0000, 0.0000] })
    Tree 6: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(2), right: Tree(5), normal: [0.0000, 0.0000] })
    Tree 7: Descendants(Descendants { descendants: [3, 4] })
    Tree 8: Descendants(Descendants { descendants: [2] })
    Item 0: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [0.0000, 0.0000] })
    Item 1: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [1.0000, 0.0000] })
    Item 2: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [2.0000, 0.0000] })
...
fn delete_one_leaf_in_a_split() {
    ...
    Tree 0: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(1), right: Tree(2), normal: [0.0000, 0.0000] })
    Tree 1: Descendants(Descendants { descendants: [1] })
    Tree 2: Descendants(Descendants { descendants: [0, 2] })
    Item 0: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [0.0000, 0.0000] })
    Item 1: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [1.0000, 0.0000] })
    Item 2: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [2.0000, 0.0000] })
    "###);
...
fn delete_one_item() {
    ...
    Tree 0: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(1), right: Tree(6), normal: [1.0000, 0.0000] })
    Tree 1: Descendants(Descendants { descendants: [0] })
    Tree 2: Descendants(Descendants { descendants: [5] })
    Tree 5: Descendants(Descendants { descendants: [2, 4] })
    Tree 6: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(2), right: Tree(5), normal: [0.0000, 0.0000] })
    Item 0: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [0.0000, 0.0000] })
    Item 2: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [2.0000, 0.0000] })
...
fn add_one_item_incrementally_to_create_a_split_node() {
    ...
    Root: Metadata { dimensions: 2, items: RoaringBitmap<[0, 1, 2]>, roots: [0], distance: "euclidean" }
    Version: Version { major: 0, minor: 6, patch: 1 }
    Tree 0: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(1), right: Tree(2), normal: [-1.0000, 0.0000] })
...
fn add_one_item_incrementally() {
    ...
    Tree 1: Descendants(Descendants { descendants: [0] })
    Tree 2: Descendants(Descendants { descendants: [1, 5] })
    Tree 3: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(7), right: Tree(8), normal: [0.0000, 0.0000] })
    Tree 4: Descendants(Descendants { descendants: [2] })
    Tree 5: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(3), right: Tree(4), normal: [0.0000, 0.0000] })
    Tree 6: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(2), right: Tree(5), normal: [0.0000, 0.0000] })
    Tree 7: Descendants(Descendants { descendants: [4, 25] })
    Tree 8: Descendants(Descendants { descendants: [3] })
    Item 0: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [0.0000, 0.0000] })
    Item 1: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [1.0000, 0.0000] })
    Item 2: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [2.0000, 0.0000] })
    Item 3: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [3.0000, 0.0000] })
    ...
    Tree 0: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(1), right: Tree(6), normal: [1.0000, 0.0000] })
    Tree 1: Descendants(Descendants { descendants: [0] })
    Tree 2: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(9), right: Tree(10), normal: [0.0000, 0.0000] })
    Tree 3: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(7), right: Tree(8), normal: [0.0000, 0.0000] })
    Tree 4: Descendants(Descendants { descendants: [2] })
    Tree 5: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(3), right: Tree(4), normal: [0.0000, 0.0000] })
    Tree 6: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(2), right: Tree(5), normal: [0.0000, 0.0000] })
    ...
    Tree 10: Descendants(Descendants { descendants: [1, 5] })
    Item 0: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [0.0000, 0.0000] })
    Item 1: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [1.0000, 0.0000] })
    Item 2: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [2.0000, 0.0000] })
    Item 3: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [3.0000, 0.0000] })
...
fn delete_extraneous_tree() {
    ...
    Tree 0: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(2), right: Tree(3), normal: [-1.0000, 0.0000, 0.0000, 0.0000] })
    Tree 1: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(5), right: Tree(6), normal: [1.0000, 0.0000, 0.0000, 0.0000] })
    ...
    Tree 6: Descendants(Descendants { descendants: [1, 2, 3, 4] })
...
fn create_root_split_node_with_empty_child() {
    ...
    Tree 0: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(1), right: Tree(5), normal: [1.0000, 0.0000] })
    Tree 1: Descendants(Descendants { descendants: [0] })
    Tree 3: Descendants(Descendants { descendants: [3, 4] })
    Tree 4: Descendants(Descendants { descendants: [2] })
    Tree 5: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(3), right: Tree(4), normal: [0.0000, 0.0000] })
    ...
    ==================
    Dumping index 0
    Root: Metadata { dimensions: 2, items: RoaringBitmap<[2, 3, 4]>, roots: [5], distance: "euclidean" }
    Tree 3: Descendants(Descendants { descendants: [3, 4] })
    Tree 4: Descendants(Descendants { descendants: [2] })
    Tree 5: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(3), right: Tree(4), normal: [0.0000, 0.0000] })
    Item 2: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [2.0000, 0.0000] })
...
fn reuse_node_id() {
    ...
    Tree 1: Descendants(Descendants { descendants: [0] })
    Tree 2: Descendants(Descendants { descendants: [1, 5] })
    Tree 5: Descendants(Descendants { descendants: [2] })
    Tree 6: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(2), right: Tree(5), normal: [0.0000, 0.0000] })
    Item 0: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [0.0000, 0.0000] })
    Item 1: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [1.0000, 0.0000] })
    Item 2: Leaf(Leaf { header: NodeHeaderEuclidean { bias: 0.0 }, vector: [2.0000, 0.0000] })
    ...
    Tree 0: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(1), right: Tree(6), normal: [1.0000, 0.0000] })
    Tree 1: Descendants(Descendants { descendants: [0] })
    Tree 2: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(3), right: Tree(4), normal: [0.0000, 0.0000] })
    Tree 3: Descendants(Descendants { descendants: [4, 5] })
    Tree 4: Descendants(Descendants { descendants: [1] })
    ...
    Tree 5: Descendants(Descendants { descendants: [2, 3] })
    Tree 6: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(2), right: Tree(5), normal: [0.0000, 0.0000] })
    Tree 7: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(14), right: Tree(15), normal: [-1.0000, 0.0000] })
    Tree 8: Descendants(Descendants { descendants: [2] })
    ...
    Tree 11: Descendants(Descendants { descendants: [] })
    Tree 12: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(10), right: Tree(11), normal: [0.0000, 0.0000] })
    Tree 13: Descendants(Descendants { descendants: [1, 3] })
    Tree 14: SplitPlaneNormal(SplitPlaneNormal<euclidean> { left: Tree(12), right: Tree(13), normal: [0.0000, 0.0000] })
